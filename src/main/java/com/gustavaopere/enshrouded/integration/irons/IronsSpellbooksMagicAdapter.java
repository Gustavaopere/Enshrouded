package com.gustavaopere.enshrouded.integration.irons;
 ...
 */
public final class IronsSpellbooksMagicAdapter implements MagicDamageClassifier {
    ...
    public MagicDamageClassification classify(DamageSource source) {
        ...
        return source.typeHolder().unwrapKey()
                ...
                .orElseGet(IronsSpellbooksMagicAdapter::unknown);
    }
