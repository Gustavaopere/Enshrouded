...
public record FlameProgressionState(
    ...
    /**
     * Atomically records one ritual checkpoint together with its resulting progression levels.
     * Duplicate ritual IDs return empty and cannot grant a second advancement.
     */
    public Optional<FlameProgressionState> applyRitualCheckpoint(
        ...
        OwnerProgression nextOwner = new OwnerProgression(flameLevel, passageLevel, rituals);
    ...
    public record OwnerProgression(
        ...
        public static OwnerProgression initial() {
            return new OwnerProgression(1, 1, Set.of());
        }
    }
}
