...
final class AdvancedVfxTransitionPlannerTest {
    @Test
    void clearToShroudProducesOneEntryCue() {
    ...
    @Test
    void directClearToDeadlyUsesOnlyTheStrongerDeadlyCue() {
        var previous = new AdvancedVfxTransitionPlanner.Frame(ShroudSeverity.CLEAR, 0.0F, false, MadnessStage.STABLE);
    ...
    @Test
    void sanctuaryCueRequiresARealLatentShroudSuppressionTransition() {
    ...
    @Test
    void madnessOnlySignalsEscalationNotRecoveryOrStableRepeats() {
