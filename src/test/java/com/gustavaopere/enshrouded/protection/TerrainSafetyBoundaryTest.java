...
class TerrainSafetyBoundaryTest {
    @Test
    void terrainSafetyTypesExposeTheFailClosedBoundary() throws Exception {
        ...
        Method fromConfig = authorityType.getMethod("fromConfig", FlameWardQuery.class, protectedAreaType);
        assertEquals(authorityType, fromConfig.getReturnType());
    }
