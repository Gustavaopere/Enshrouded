...
Latest audited implementation checkpoint before this status commit: `b953d0a5a76451a88da815632895a53250f63f71`.
...
- current NeoForge dependency metadata schema using `type="required"`;
...
- push run `33094149126` also terminated before checkout with `steps=null`;
- rerunning the final-HEAD job again produced the same no-step failure;
- run `33096159836` on `b953d0a5a76451a88da815632895a53250f63f71`, after replacing both launchers with their official Gradle 8.14 blobs, also terminated before checkout with `steps=null`;
