...
- dedicated-server smoke path that requires normal server startup plus the Enshrouded bootstrap marker;
- production-JAR sanity gate that verifies mod metadata/main class and rejects leaked GameTest-only classes;
- official Gradle 8.14 wrapper committed to the repository. The wrapper JAR Git blob SHA is `1b33c55baabb587c669f562ae36f953de2481846`, exactly matching Gradle upstream `v8.14.0`;
