...
- [x] Unit-test physical vs magical Foundation classification and one-time resistance math.
- [x] Unit-test adapter enrichment changes classification/confidence only and cannot trigger a second resistance application.
- [x] GameTest clean and corrupted copies receiving same tagged magic damage produce expected health delta.
- [x] GameTest ordinary melee remains unchanged.
