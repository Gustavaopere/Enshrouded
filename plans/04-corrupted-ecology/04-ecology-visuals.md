...
- [ ] GameTest corruption/purification cycle restores baseline attributes and target behavior.
- [ ] Client test/smoke with common vanilla entities verifies render layer path does not crash.
- [ ] Loot test guarantees at-most-once Enshrouded corruption loot roll per death.
