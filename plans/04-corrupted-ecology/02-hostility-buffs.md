...
- [ ] GameTest corrupted passive targets nearby survival player but clean counterpart does not.
- [ ] GameTest purification removes Enshrouded target behavior.
- [ ] Unit-test repeated modifier application is idempotent and capped.
- [ ] GameTest a third-party/mock hostile retains native target behavior while stats change.
